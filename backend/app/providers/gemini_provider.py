from app.config.config import GEMINI_API_KEY, DEFAULT_TEMPERATURE, DIRECT_SUMMARIZATION_LIMIT, SUMMARY_STYLE_CONFIG, MAX_PARALLEL_REQS
...
class GeminiProvider(BaseProvider):
    ...
    async def _generate_summary(self, document: str, style: SummaryStyle) -> ModelResult:
        ...
        return ModelResult(
            ...
            estimated_cost_usd = estimate_cost(self.model_name, usage.prompt_token_count, usage.candidates_token_count)
        )
